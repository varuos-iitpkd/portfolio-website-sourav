...
const info = [
  ...
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
    descripiton: "Whitefield, Bengaluru",
  },
];
            ...
            <div className="xl:w-[54%] order-2 xl:order-none">
              <form className="flex flex-col gap-6 p-10 bg-[#28282c] rounded-xl">
                ...
                <p className="text-white/60">
                  ...
                  Incidunt natus explicabo reiciendis aut itaque veritatis!
                </p>
                {/* input */}
                ...
                />
                {/* btn */}
                <Button size="md" className="max-w-40 h-14">
                  Send message
                </Button>
              </form>
            </div>
